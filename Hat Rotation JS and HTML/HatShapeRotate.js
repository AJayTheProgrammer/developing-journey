...
window.onload = function init() {
    ...
    document.getElementById("rightval").onclick =
        function () {
            theta += 0.1;
        };

    document.getElementById("leftval").onclick =
        function () {
            theta -= 0.1;
        };

    document.getElementById("upval").onclick =
        function () {
            phi += 0.1;
            
        };

    document.getElementById("downval").onclick =
        function () {
            phi -= 0.1;
        };
